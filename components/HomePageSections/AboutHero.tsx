...
export default function AboutHeroSection() {
  return (
    ...
    <section className="container m-auto relative flex min-h-[70vh] font-sans ml-[12%]">
      {/* Backgrounds */}
      <div className="w-2/5 bg-brand-grey relative">
        <div
          aria-hidden="true"
      ...
      <div className="w-3/5 bg-white relative mt-20">
